...
public class Main {
    public static void main(String[] args) { // Método Principal
        ...
        if(perguntaInicial.equals("sim")){ // Se a pergunta inicial for igual a "sim" ->
            ...
            int tentativasRestantes = 10; // Controla o número de tentativas que o jogador faz
            int controleTentativas = 0; // Controla e diz o número máximo de tentativas que o jogador pode fazer
            ...
            while (controleTentativas < tentativasRestantes && !palavraAcertada) { // Este é um Loop que continua a execução do jogo emquanto o número de tentavias do jogador é menor que o número máximo e enquanto a palavra não é acertada
                ...
                if(jogador.length() == 1){ // Se o jogador colocar apenas uma coisa/letra ->
                    ...
                    if(tentativasRestantes == controleTentativas){ // Se o jogador fizer o máximo de tentativas e não ganhar o jogo ->
                    ...
                    tentativasRestantes++; // (Aumento/Deixo igual) o número de tentativas restantes 
                }
            }
